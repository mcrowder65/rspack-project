...
export declare type LogTypeEnum = typeof LogType[keyof typeof LogType];
...
export declare type LogFunction = (type: LogTypeEnum, args?: any[]) => void;
export declare type GetChildLogger = (name: string | (() => string)) => Logger;
