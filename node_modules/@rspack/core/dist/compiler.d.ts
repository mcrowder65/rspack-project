...
declare class Compiler {
    ...
    rebuild(modifiedFiles: ReadonlySet<string> | undefined, removedFiles: ReadonlySet<string> | undefined, cb: ((error?: Error) => void) | undefined): void;
    watch(watchOptions: WatchOptions, handler: (error: Error, stats: Stats) => void): Watching;
