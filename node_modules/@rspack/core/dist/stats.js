...
class Stats {
    ...
    toJson(opts, forToString) {
        ...
        if (options.modules) {
            obj.modules = __classPrivateFieldGet(this, _Stats_inner, "f").getModules((_a = options.reasons) !== null && _a !== void 0 ? _a : false);
        }
        ...
        if (options.errorsCount) {
            obj.errorsCount = ((_b = obj.errors) !== null && _b !== void 0 ? _b : __classPrivateFieldGet(this, _Stats_inner, "f").getErrors()).length;
        }
        if (options.warnings) {
            obj.warnings = __classPrivateFieldGet(this, _Stats_inner, "f").getWarnings();
        }
        if (options.warningsCount) {
            obj.warningsCount = ((_c = obj.warnings) !== null && _c !== void 0 ? _c : __classPrivateFieldGet(this, _Stats_inner, "f").getWarnings()).length;
        }
